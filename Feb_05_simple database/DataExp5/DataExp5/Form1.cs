...
namespace DataExp3
{
    public partial class Form1 : Form
    {
        //my code : change this code
         SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\datasource\vehicle_list_1.mdf;Integrated Security=False;Connect Timeout=30");
        // change thsi code
        ...
        public void view()
        {
            ...
            SqlDataAdapter SDA = new SqlDataAdapter(@"SELECT RegNo,Model,Make FROM fourwheels", con);
            //DataTable 
            DATA = new DataTable();
            SDA.Fill(DATA);
        ...
        {                        
           // SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\datasource\vehicle_list_1.mdf;Integrated Security=True;Connect Timeout=30");
            ...
            {
                con.Open();
                SqlDataAdapter da = new SqlDataAdapter(@"INSERT INTO fourwheels(RegNo, Model, Make) VALUES ('" + txtRegNo.Text + "','" + txtCarModel.Text + "','" + txtCarMake.Text + "')", con);
        ...
        private void btnUpdateData_Click(object sender, EventArgs e)
        {
          ...
          //  SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\datasource\vehicle_list_1.mdf;Integrated Security=True;Connect Timeout=30");
            ...
            {
                con.Open();
                SqlDataAdapter da = new SqlDataAdapter (@"UPDATE fourwheels SET Model='" + txtCarModel.Text + "', Make='" + txtCarMake.Text + "' WHERE RegNo='" + txtRegNo.Text + "' ", con);
                da.SelectCommand.ExecuteNonQuery();
        ...
        private void btnDeleteData_Click(object sender, EventArgs e)
        {
          ...
          //  SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\datasource\vehicle_list_1.mdf;Integrated Security=True;Connect Timeout=30");
            ...
            try
            {
                ...
                con.Open();
                SqlDataAdapter da = new SqlDataAdapter(@"DELETE FROM fourwheels WHERE RegNo='" + txtRegNo.Text + "' ", con);
                da.SelectCommand.ExecuteNonQuery();
