...
namespace DataExp3
{
    public partial class Form1 : Form
    {
        ...
        public void view()
        {
            ...
            OleDbDataAdapter SDA = new OleDbDataAdapter(@"SELECT SlNo, CustomerName, Dates1, Total_Quote_Value FROM Quotes", con);
        ...
        private void btnInsertData_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                OleDbDataAdapter da = new OleDbDataAdapter(@"INSERT INTO Quotes( SlNo, CustomerName, Dates1, Total_Quote_Value ) VALUES (  " + txtSLNo.Text + " ,' " + txtCustName.Text + " ' , ' " + dateTimePicker1.Text + " ' , ' " + txtTotalQuoteVal.Text + " ') ", con);
